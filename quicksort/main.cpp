...
int partition(int tablica[], int p, int r) // dzielimy tablice na dwie czesci, w
//pierwszej wszystkie liczby sa mniejsze badz rowne x, w drugiej wieksze lub
//rowne od x
{
...
void quicksort(int tablica[], int p, int r) // sortowanie szybkie
{
    ...
    if (p < r)
    {
        ...
        // dzielimy tablice na dwie czesci; q o znacza punkt podzialu
        quicksort(tablica, p, q);
        // wywolujemy rekurencyjnie quicksort dla pierwszej czesci tablicy

        quicksort(tablica, q+1, r);
        // wywolujemy rekurencyjnie quicksort dla drugiej czesci tablicy
    }
}
...
//   // utworzenie dynamicznej tablicy na ilosc_liczb' elementow
// 
